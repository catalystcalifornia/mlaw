...
equity_data_popup <- paste0("<div class='equity'> <div class='leaflet-data-equity' data-equity-zipcode='", equity_df$zipcode,
               "' data-equity-percentile='", round(equity_df$pctile,1),
               "' data-equity-percentile-category='", equity_df$pctile_category,
...
L.Map.addInitHook(function () {
  ...
  mapsPlaceholder.forEach(map => {
      ...
      map.on('popupopen', (e) => {
        ...
        equityCategory = popupEquity.getAttribute('data-equity-percentile-category')
