...
L.Map.addInitHook(function () {
  ...
  mapsPlaceholder.forEach(map => {
      ...
      map.on('load', (e) => {
        ...
        document.querySelector('.equity-population').innerHTML = "38430"
