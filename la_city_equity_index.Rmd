...
Please visit our recommendations page to read our full recommendations to the City and see our [GitHub repository](https://github.com/catalystcalifornia/mlaw/blob/main/README.md) to view our full methodology.
...
```
Data Source: Earth Resources Observation and Science Center, National Land Cover Database, 2021. 
...
```
Data Source: IRS Exempt Organizations Business Master File, 2024.
...
```
Data Source: Calculations based on USDA Food and Nutrition Service, SNAP Retailer Location Data, 2024.


### Correlations

This matrix shows the relationship between every indicator in the domain. Larger and darker blue circles represent indicators with greater positive relationships--meaning as one rate goes up, so does the other. Larger and darker red circles show which indicators have a negative relationship--meaning as a measure for one indicator goes up, the other goes down. Blank squares on the correlation matrix indicate that there is not a significant relationship between the indicators.  
...
# Partners
This work would not have been possible without the collaboration and invaluable insights provided by our partners in the MLAW Coalition. MLAW Coalition partners include: Community Coalition, Inner City Struggle, Black Women for Wellness, Brotherhood Crusade, SEIU 99, and SEIU 2015.
